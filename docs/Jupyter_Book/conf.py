...
html_baseurl = ''
html_favicon = ''
html_logo = '../assets/Logo_Dosepy.png'
html_sourcelink_suffix = ''
html_theme = 'sphinx_book_theme'
html_theme_options = {'search_bar_text': 'Search this book...', 'launch_buttons': {'notebook_interface': 'classic', 'binderhub_url': '', 'jupyterhub_url': '', 'thebe': False, 'colab_url': ''}, 'path_to_docs': 'docs/Jupyter_Book', 'repository_url': 'https://github.com/LuisOlivaresJ/Dosepy/tree/main/docs/Jupyter_Book', 'repository_branch': 'master', 'extra_footer': '', 'home_page_in_toc': True, 'announcement': '', 'analytics': {'google_analytics_id': ''}, 'use_repository_button': True, 'use_edit_page_button': False, 'use_issues_button': True}
html_title = 'Dosepy Jupyter Book'
