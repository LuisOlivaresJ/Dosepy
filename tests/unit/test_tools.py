...
# Test average function using 18 files
def test_average_with_path_as_str():
    ...
    images = average(path_to_files, all_images)
...
# Test average using path as pathlib.PosixPath
def test_average_with_path_as_PosixPath():
    path_to_folder = "/media/luis/TOMO/Dosepy/BQT_INCAN/Cal_Der/"
